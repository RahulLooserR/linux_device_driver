 ...
 * tasklet_name -> tasklet not required to declare
 *
...
static int __init chr_dev_init(void)
{
	...
	if(request_irq(IRQ_NO, irq_handler, IRQF_SHARED, "my_char_intr", (void *)(irq_handler)))
	{
	...
	/* dynamic method of initializing tasklets */
